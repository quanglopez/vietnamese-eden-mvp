...
Liên quan: [beta-onboarding.md](./beta-onboarding.md) · [beta-invite-message.md](./beta-invite-message.md) · [feedback-triage.md](./feedback-triage.md)
...
4. Phần nào **hữu ích nhất**? (Breakdown / Remix / Voice / Calendar / Board)  
5. Output AI có cần **chỉnh nhiều** trước khi đăng không? (1–5)  
6. Bạn có trả phí ~___k VNĐ/tháng cho tool này không? Tại sao? (optional)

### C. UX & bug

7. Chỗ nào **khó hiểu** nhất? (screenshot welcome)  
8. Có lỗi / message đỏ không? (paste text + URL trang)  
9. Thiết bị: Desktop / Mobile / Cả hai?

### D. Mở

10. Một điều bạn muốn có **ngay tuần sau**? (feature request — không cam kết ship)
